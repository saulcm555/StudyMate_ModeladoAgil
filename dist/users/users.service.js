...
let UsersService = class UsersService {
    ...
    async create(createStudentDto) {
        ...
        if (studentExists)
            throw new common_1.ConflictException(`Student with email ${email} already exists`);
    ...
    async findByEmail(email) {
        ...
        if (!user) {
            throw new common_1.BadRequestException('User with email not found');
        }
        return user;
    }
...
exports.UsersService = UsersService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(user_entity_1.Student)),
